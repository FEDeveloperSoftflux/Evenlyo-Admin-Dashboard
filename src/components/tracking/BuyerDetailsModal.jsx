  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      >
        ...
        <div className="mb-4">
          <h4 className="text-sm font-medium text-gray-700 mb-2">Buyer Details</h4>
          <div className="flex items-center gap-3 mb-4">
            ...
            />
            <div>
              <div className="text-base font-semibold text-gray-900">{buyer.name}</div>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-700">B001</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-700">john@example.com</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-700">456 Business Ave, Commerce City</div>
            </div>
          </div>
        </div>
